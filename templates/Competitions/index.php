...
<div class="competitions index">
	...
	<tr<?php echo $class;?>>
		...
		<td class="actions">
			...
			<?php if ($mayDelete) echo $this->Html->link(__('Delete'), array('action' => 'delete', $competition['id']), ['confirm' => sprintf(__('Are you sure you want to delete %s?'), $competition['description'])]); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
