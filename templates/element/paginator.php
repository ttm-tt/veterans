...
<?php
	...
	$templates = [
		...
		'nextDisabled' => '<span class="next disabled"><a href="" onclick="return false;">{{text}}</a></span>',
		'prevActive' => '<span class="prev"><a rel="prev" href="{{url}}">{{text}}</a></span>',
		'prevDisabled' => '<span class="prev disabled"><a href="" onclick="return false;">{{text}}</a></span>',
