...
<?php
/** 
 * Based on https://github.com/Xety/Cake3-CookieAuth 
 * which in turn is based on https://github.com/friendsofcake/Authenticate
 * But no checkin happened there for a long time, so keep it here
 */
...
class CookieAuthenticate extends BaseAuthenticate
{
    ...
    public function __construct(ComponentRegistry $registry, array $config = [])
    {
        ...
        $this->config([
            ...
            'cookie' => [
                'name' => Configure::read('Session.authcookie')
            ]
        ]);
    ...
    public function authenticate(Request $request, Response $response)
    {
		...
		// Sets $username and $password to the column names for username and password
